...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js")], __WEBPACK_AMD_DEFINE_RESULT__ = (function ($) {
  ...
  var uploadButton = document.getElementById('save-fish');
  ...
  var fishId = window.location.pathname.replace('/fish/', '').replace('/edit', '');
  ...
  function validation() {
    var message = [];
    var nameValidator = new RegExp(/^[a-žA-Ž\s]+$/); //name consists only form letters and whitespaces
  ...
  function editFish() {
    ...
    $.ajax({
      ...
      method: "POST",
      url: "".concat(path, "/fish/").concat(fishId),
      dataType: 'html',
      headers: {
...
/***/ 9:
/*!**************************************!*\
  !*** multi ./resources/js/fish/edit ***!
  \**************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! C:\wamp64\www\KursaDarbs_rn18011\kursa-darbs\resources\js\fish\edit */"./resources/js/fish/edit.js");
